                            ...
                            if (dt2 != null)
                            {
                                ...
                                foreach (DataRow dr2 in dt2.Rows)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(patient) && !string.IsNullOrEmpty(Item) && !string.IsNullOrEmpty(score) && !string.IsNullOrEmpty(phone) && !string.IsNullOrEmpty(doctor))
                                    {
                                        ...
                                        bool s = bll.ExistMinute(phone, beginTime.ToString("yyyy-MM-dd HH:mm:ss"), endTime.ToString("yyyy-MM-dd HH:mm:ss"));
...
>>>>>>> 66ccdcc4874453ee0178be9d2f23e6d3a62b10a5
                                        ...
                                        else
                                        {
                                            ...
                                            if (!hasValue || (hasValue&&!bll2.Exists(phone, Item, score, patient_id, 1)))//不存在或者状态为0 发送
                                            {
